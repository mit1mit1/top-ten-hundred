...
const definitions = {
  ...
  "can't": `short for "can not" (there's actually another way to make that short, but I can't write it with what I can use here) - when, anyway you try, you will not be able to do a thing`,
  ...
  caught: "",
  cause: "the thing that did make another thing be the way it is - or - an idea you should work for, except if it is a lost cause, in which case, an idea that you shouldn't work for",
  cell: "",
  ...
  class: "",
  clean: "to not have any not nice stuff stuck to you - or - to take the not nice stuff off something, often with water or with a wipe",
  ...
  counter: "",
  couple: "two of something - or - two people who like each other a lot and stay together a lot, who like to do stuff by themselves",
  course: "",
  ...
  disappear: "",
  do: "act in some way",
  doctor: "a person who can often make a sick person not sick - maybe they will fix a tear on your skin - or - a person who should understand a lot because they did a lot of school",
  ...
  game: "something we can do for fun - maybe we'll kick a round soft between each other, or maybe we'll flip a card over and see if it is the same as another card",
  gasp: "",
  gave: "",
  ...
  locker: "",
  long: "",
  look: "to point your eye at a thing, maybe with a glance or gaze, so you can see it - or - how a thing does seem when you look at it",
  lose: "to not have a thing you did have anymore - maybe because you didn't notice where it went, or because you threw it away when you didn't want to - or - not come first, be beat by someone in a game or race",
  ...
  move: "go from one spot to another - maybe fast or maybe slow, maybe toward something or maybe away from it",
  ...
  new: "",
  next: "",
  nice: `a thing that will make you a bit happy - or - a kind and fine thing - or - a word we might use to say that we're happy about something, like "alright!" or "cool!"`,
  ...
  none: "",
  normal: "",
  nose: "the bit of your face that has a corner in front of the rest of your face, and a whole on the left and the right that air can enter through if you want to breathe through something that isn't your mouth",
  not: "",
  note: "",
  ...
  pink: "",
  piss: "",
  place: "somewhere - a thing you can move to, can approach or arrive at or visit - something in space, like a home or a city or a shop",
  plan: "",
  play: "",
  please: "",
  pocket: "",
  ...
  see: "to be able to notice what is in a straight line from your eye, if it is bright enough - to feel how a thing does appear",
  seem: "",
  seen: "",
  self: "",
  send: "",
  ...
  slam: "",
  sleep: "to close your left eye and your right eye and not think for a little while - if she's got a heavy head, a sleep should help - before you woke this morning, you did sleep",
  slightly: "",
  slip: "",
  ...
  smell: "to be able to notice what is in the air around you with your nose - or - the stuff in the air around you that you can notice with your nose - maybe stuff you want to avoid like the smell of a shit, or stuff that you want to approach like the smell of breakfast",
  ...
  store: "put a thing where you can get it at a time still to come, maybe somewhere you need a key to open so only you can get it - or - a shop",
  ...
  wore: "",
  work: "what you do to get money, often from the morning until the afternoon - or more often than that, if you are too busy",
...
const getDefinedWords = (definitions2) => Object.entries(definitions2).filter((entry) => entry[1].length > 0);
...
function create_fragment(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*definitions, sanitizeWord, splitDefinition, selectedWord, clicks*/
      7) {
        each_value = /*splitDefinition*/
        ctx2[1];
        let i;
...
function instance($$self, $$props, $$invalidate) {
  ...
  const click_handler = (word) => {
    if (definitions[sanitizeWord(word)]) {
      ...
      $$invalidate(1, splitDefinition = definitions[sanitizeWord(word)].split(" "));
      $$invalidate(2, clicks++, clicks);
    }
  };
  return [selectedWord, splitDefinition, clicks, click_handler];
}
