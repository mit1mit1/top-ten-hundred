...
// 'buy',    'couch',   'cover',   'exclaim', 'fall',      'fell',
// 'fight',  'how',     'ice',     'if',      'important', 'instead',
// 'is',     'it',      'its',     'just',    'keep',      'kind',
// 'knee',   'know',    'last',    'late',    'least',     'left',
// 'less',   'let',     'lie',     'life',    'like',      'line',
// 'little', 'live',    'long',    'look',    'lose',      'lot',
// 'loud',   'low',     'made',    'make',    'many',      'may',
// 'maybe',  'me',      'mean',    'meant',   'middle',    'might',
// 'mine',   'mirror',  'more',    'morning', 'most',      'mother',
